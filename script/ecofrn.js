      ...
      function showSlides1(m) {
        let dots = document.getElementsByClassName("dot2");
         ...
         for (j = 0; j < dots.length; j++) {
            dots[j].className = dots[j].className.replace(" active2", "");
         }
         slides1[slideIndex1-1].style.display = "block";
         dots[slideIndex1-1].className += " active2";
      }
let slideIndex3 = 1;
      ...
      function showSlides3(p) {
         ...
         for (k = 0; k < dots.length; k++) {
            dots[k].className = dots[k].className.replace(" active3", "");
         }
...
let slideIndex5 = 1;
      ...
      function showSlides5(q) {
        let dots = document.getElementsByClassName("dot5");
         ...
         for (j = 0; j < dots.length; j++) {
            dots[j].className = dots[j].className.replace(" active5", "");
         }
